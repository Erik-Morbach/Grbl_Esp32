...
#define DEFAULT_X_MAX_TRAVEL 274.1// $130 mm NOTE: Must be a positive value.
#define DEFAULT_Z_MAX_TRAVEL 113.2  // $132 mm NOTE: Must be a positive value.
...
#define DEFAULT_SPINDLE_DELAY_SPINDOWN 3
